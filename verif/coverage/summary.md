...
| `tokio` | 1.52.1 | `elicit_tokio` | 0 | 2 | 0.0% |
| `tower` | 0.5.3 | `elicit_tower` | 0 | 5 | 0.0% |
| `axum` | 0.8.9 | `elicit_axum` | 0 | 137 | 0.0% |
| `reqwest` | 0.13.3 | `elicit_reqwest` | 5 | 30 | 16.7% |
...
| Kind | Count | Notes |
|------|------:|-------|
| Missing | 13014 | Upstream type not yet shadowed |
| Drifted | 55 | Probable rename — similar name in shadow crate |
| PossiblyStale | 396 | Shadow type with no matching upstream — needs audit |
